...
Route::controller(AuthController::class)->prefix('auth')->group(function () {
    ...
    Route::get('/forgot-password', 'requestResetPassword')->name('password.request');
    Route::post('/forgot-password','sendEmailResetPassword')->name('password.email');
    Route::get('/reset-password/{token}', 'createNewPassword')->name('password.reset');
    Route::post('/reset-password', 'resetPassword')->name('password.reseted');
});
